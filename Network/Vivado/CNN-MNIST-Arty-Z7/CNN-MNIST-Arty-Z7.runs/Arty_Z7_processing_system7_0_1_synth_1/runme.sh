...
HD_PWD='C:/Network/Vivado/CNN-MNIST-Arty-Z7/CNN-MNIST-Arty-Z7.runs/Arty_Z7_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Arty_Z7_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Arty_Z7_processing_system7_0_1.tcl
