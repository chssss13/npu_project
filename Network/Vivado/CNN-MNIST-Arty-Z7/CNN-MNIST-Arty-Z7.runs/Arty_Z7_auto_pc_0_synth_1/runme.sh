...
HD_PWD='C:/NPU_project/CNN-Handwritten-Digit-MNIST-main/CNN-Handwritten-Digit-MNIST-main/Network/Vivado/CNN-MNIST-Arty-Z7/CNN-MNIST-Arty-Z7.runs/Arty_Z7_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Arty_Z7_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Arty_Z7_auto_pc_0.tcl
